...
class ProductPage(BasePage):
    ...
    def should_be_msg_about_adding_to_basket(self):
        book = self.get_text_of_element(*ProductPageLocators.BOOK_NAME)
        msg = self.get_text_of_element(*ProductPageLocators.MESSAGE_ABOUT_ADDING_TO_BASKET)
        price = self.get_text_of_element(*ProductPageLocators.PRICE)
        ...
        assert book in msg, "Book title in the message is incorrect"
